...
<<'many_sims_plotz',dependson=c('many_sims', 'plot_funcs'),echo=FALSE,eval=TRUE,cache=TRUE,fig.width=10,fig.height=5.5,out.width="0.975\\textwidth",fig.pos='h',fig.cap=fig_cap>>=
...
<<'causal_tfive_sims_plotz',dependson=c('causal_tfive_sims','plot_funcs'),echo=FALSE,eval=TRUE,cache=TRUE,fig.width=10,fig.height=5.5,out.width="0.975\\textwidth",fig.pos='h',fig.cap=fig_cap>>=
alpha <- 0.05
fig_cap <- paste0('The computed p-values from the conditional estimation procedure over ',nsim,
...
<<'power_plotz_old_one',dependson=c('proc_sims_vs','plot_funcs'),echo=FALSE,eval=FALSE,cache=TRUE,fig.width=10,fig.height=5.5,out.width="0.975\\textwidth",fig.pos='h',fig.cap=fig_cap>>=
...
print(ph)
@
<<'power_plotz_one_a',dependson=c('proc_sims_vs','plot_funcs'),echo=FALSE,eval=TRUE,cache=TRUE,fig.width=10,fig.height=5.5,out.width="0.975\\textwidth",fig.pos='h',fig.cap=fig_cap>>=
...
print(ph)
@
<<'power_plotz_one_b',dependson=c('proc_sims_vs','plot_funcs'),echo=FALSE,eval=TRUE,cache=TRUE,fig.width=10,fig.height=5.5,out.width="0.975\\textwidth",fig.pos='h',fig.cap=fig_cap>>=
...
<<'power_plotz_pvsnr_distribution',dependson=c('resu_two_summary','plot_funcs'),echo=FALSE,eval=TRUE,cache=TRUE,fig.width=10,fig.height=5.5,out.width="0.975\\textwidth",fig.pos='h',fig.cap=fig_cap>>=
...
<<'power_plotz_two',dependson=c('sims_vs_mht_two','plot_funcs'),echo=FALSE,eval=TRUE,cache=TRUE,fig.width=10,fig.height=5.5,out.width="0.975\\textwidth",fig.pos='h',fig.cap=fig_cap>>=
...
print(ph)
@
<<'power_plotz_two_sel_prob',dependson=c('sims_vs_mht_two','plot_funcs'),echo=FALSE,eval=TRUE,cache=TRUE,fig.width=10,fig.height=5.5,out.width="0.975\\textwidth",fig.pos='h',fig.cap=fig_cap>>=
...
check_types <- c('onegood','uniform','bellshaped')

# actual run the sims
params <- data_frame(one_zeta=seq(0.0025,0.045,length.out=9)) %>%
...
fdr_data <- resu_fdr %>%
  ...
  ungroup() %>%
  mutate(fdr = (fp_count + 0.5)/(rej_count + 1.0)) %>%
...
<<'plot_fdr',dependson=c('collect_sims_fdr','plot_funcs'),echo=FALSE,eval=TRUE,cache=TRUE,fig.width=10,fig.height=5.5,out.width="0.975\\textwidth",fig.pos='h',fig.cap=fig_cap>>=
fig_cap <- paste0("The empirical False Discovery Rate (FDR) of the ",
                  ...
                  "The FDR is defined as the probability that the asset with maximum \\txtSR is null ($\\zeta \\le 0$) ",
                  "conditional on the test rejecting the null, ",
                  "in other words, the false positive rate divided by the rejection rate. ",
  ...
  #geom_hline(yintercept=0.05,linetype=2,alpha=0.7) +
fdr_data %>%
  filter(method %in% c('condest','mht','chibarsquare')) %>%
  ...
  labs(x='maximum population signal noise ratio',
       ...
       title='False Discovery Rate of tests')
@
...
<<'rho_plotz_one',dependson=c('correlation_sims_vs_mht','plot_funcs'),echo=FALSE,eval=TRUE,cache=TRUE,fig.width=10,fig.height=5.5,out.width="0.975\\textwidth",fig.pos='h',fig.cap=fig_cap>>=
