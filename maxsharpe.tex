...
\begin{knitrout}\small
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}[h]
\includegraphics[width=0.975\textwidth,height=0.682\textwidth]{figure/maxsharpe_plot_fdr-1} \caption{The empirical positive False Discovery Rate (pFDR) of the conditional estimation and MHT procedures are shown versus the maximum population \txtSNR for various arrangements of the true \txtSNR. The pFDR is defined as the probability that the asset with maximum \txtSR is null ($\zeta \le 0$) conditional on the test rejecting the null, in other words, the false positive rate divided by the rejection rate. \cite{10.1111/1467-9868.00346} We perform 10,000 simulations with $\ssiz=1008$, $\nstrat=105$. }\label{fig:plot_fdr}
\end{figure}
...
\begin{knitrout}\small
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}[h]
\includegraphics[width=0.975\textwidth,height=0.682\textwidth]{figure/maxsharpe_plot_fdr_II-1} \caption{The empirical positive False Discovery Rate (pFDR) of the conditional estimation and MHT procedures are shown versus the maximum population \txtSNR for various arrangements of the true \txtSNR. The pFDR is defined as the probability that the asset with maximum \txtSR is null ($\zeta \le 0$) conditional on the test rejecting the null, in other words, the false positive rate divided by the rejection rate. \cite{10.1111/1467-9868.00346} We perform 100,000 simulations with $\ssiz=1008$, $\nstrat=105$. }\label{fig:plot_fdr_II}
\end{figure}

\end{knitrout}
\begin{knitrout}\small
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}[h]
\includegraphics[width=0.975\textwidth,height=0.682\textwidth]{figure/maxsharpe_plot_fdr_III-1} \caption{The empirical positive False Discovery Rate (pFDR) of the conditional estimation and MHT procedures are shown versus the maximum population \txtSNR for various arrangements of the true \txtSNR. The pFDR is defined as the probability that the asset with maximum \txtSR is null ($\zeta \le 0$) conditional on the test rejecting the null, in other words, the false positive rate divided by the rejection rate. \cite{10.1111/1467-9868.00346} We perform 100,000 simulations with $\ssiz=1008$, $\nstrat=105$. }\label{fig:plot_fdr_III}
\end{figure}
