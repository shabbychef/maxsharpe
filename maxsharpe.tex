...
We have performed
$\ensuremath{10^{5}}$ simulations for each setting of the `good'
...
occuring even once over the $\ensuremath{10^{5}}$ simulations performed
for each setting. 
...
and $\psnr=\vzero$.
Again we consider $\nstrat=20$, 
$\ssiz=504$, and perform $\ensuremath{10^{4}}$ simulations to estimate the 
