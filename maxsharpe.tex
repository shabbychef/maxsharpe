...
\begin{knitrout}\small
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}[h]
\includegraphics[width=0.975\textwidth]{figure/maxsharpe_power_plotz_one-1} \caption[The empirical power of the conditional estimation, MHT corrected test, chi-bar-square test, and Follman's test and one-sided test are shown versus the \txtSNR of the asset with maximum \txtSR under different arrangements of the vector \pvsnr]{The empirical power of the conditional estimation, MHT corrected test, chi-bar-square test, and Follman's test and one-sided test are shown versus the \txtSNR of the asset with maximum \txtSR under different arrangements of the vector \pvsnr. For the one-good case, the chi-bar-square and Follman's test have the same power, which is essentially zero under the alternative. }\label{fig:power_plotz_one}
\end{figure}
