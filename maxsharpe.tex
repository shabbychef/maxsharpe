...
We repeat this experiment 10,000 times and collect the resultant putative p-values.
...
$5,000$ simulations, computing p values from the feasible estimator.
...
Again we perform $1,000$ simulations with
$\nstrat=100$,
$\RMAT=\makerho{0.7}{0.3}$,
$\ssiz=1260\dayto{}$, \etc
...
For each setting we perform $1,000$ simulations then 
...
We have performed
$1,000$ simulations for each setting of the `good'
...
occuring even once over the $1,000$ simulations performed
for each setting. 
...
and $\psnr=\vzero$.
Again we consider $\nstrat=20$, 
$\ssiz=504$, and perform $1,000$ simulations to estimate the 
...
$\left[0.14\,\moto{-\halff}, \infty\right)$.
