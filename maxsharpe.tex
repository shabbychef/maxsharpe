...
The document you are reading was built from commit \texttt{f550f045c1ffa218ec4360a2a4be63535f87571f} of that repo.
}}
...
\begin{knitrout}\small
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}[h]
\includegraphics[width=0.975\textwidth]{figure/maxsharpe_power_plotz_pvsnr_distribution-1} \caption[The counts of the values of \pvsnr are shown for the uniform and bell-shaped simulations under the alternative]{The counts of the values of \pvsnr are shown for the uniform and bell-shaped simulations under the alternative. The \txtSNR is given in daily units, $\dayto{-\halff}$.}\label{fig:power_plotz_pvsnr_distribution}
\end{figure}
